...
- [Fuzzing Lists](#fuzzing-lists)
  ...
  - [SQLi](#sqli)
  - [Encodings](#encodings)
  - [Open Redirect \& Poisoning attacks](#open-redirect--poisoning-attacks)
...
## XSS
[HTML Tags (no <>)](XSS/html_tags.txt)
[Events](XSS/events.txt)
[HTML Tags (with <>) ](XSS/html_tags_full.txt)

## SQLi
[Sleep(5)](SQL/sleep_5.txt)
...
[Parameters](Open_Redirect_and_Poisoning/params.txt)

## Directory Traversal
[{file} Generic](Directory_Traversal/file_generic.txt)
